...
// const TablerIcons = () => (
//   <MainCard title="G Block Details (No data available as of now)">
...
const GTablerIcons = () => {
  ...
  const handleDeleteAll = async () => {
    setLoading(true);
    try {
      const response = await axios.delete(`http://localhost:8000/api/block/blocks/deleteAll/G`);
