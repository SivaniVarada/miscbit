...
// const TablerIcons = () => (
//   <MainCard title="H Block Details (No data available as of now)">
//    <FilterSearchblock block={'H'} department={'chemlabs'} />
//   </MainCard>
// );
...
const HTablerIcons = () => {
  ...
  const handleDeleteAll = async () => {
    setLoading(true);
    try {
      const response = await axios.delete(`http://localhost:8000/api/block/blocks/deleteAll/H`);
